...
// ============================================
// 📞 النظام المحلي - الردود المباشرة (مع جميع الإضافات)
// ============================================
...
function getLocalResponse(message) {
    ...
    if (msg.includes('مركز') || msg.includes('فرع') || msg.includes('موقع') || msg.includes('عنوان')) {
        ...
        response += `• اتصل بخدمة العملاء: **120**\n`;
        response += `• زور موقع سوداني: ${sudaniInfo.website}\n`;
        response += `• استخدم تطبيق ماي سوداني: ${sudaniInfo.mySudani}\n\n`;
...
async function getAIResponse(userMessage) {
    // 1. أولاً: التحقق من النظام المحلي (مع جميع الإضافات)
...
⚠️ **معلومات سوداني الرسمية (محدثة):**
...
• قائمة الدفع الآجل: *444#

📋 **خدمات أخرى:**
• التحويل من 3G إلى 4G: *4*400#

📱 **تطبيق ماي سوداني:**
• البوابة الرقمية الرسمية لسوداني
• تحميل: متجر Google Play
• إدارة الخط، شراء الباقات، تحويل الرصيد
• رابط: https://my.sudani.sd

💵 **تطبيق صاح (Sah):**
• محفظة إلكترونية وخدمات مالية رقمية
• تحميل: متجر Google Play
• سداد الفواتير (كهرباء، مياه، إنترنت)
• تحويلات مالية، دفع عبر QR Code
...
6. الأسعار غير مذكورة لأنها قابلة للتغيير، أنصح المستخدم بالاتصال بـ *444# أو *1# للاطلاع على العروض الحالية
...
💬 اسألني عن أي شيء!</div>
        ...
        <div class="quick-actions">
            ...
            <button onclick="sendQuickMessage('تطبيق ماي سوداني')">📱 ماي سوداني</button>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('📱 جميع الخدمات محدثة');
        });
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log('   • صاح: https://sah.sudani.sd');
    console.log('=================================');
});
